...
const cacheName = 'LAWeek4___Andrew_Howe-2021-09-15 14:05:50.885372'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4___Andrew_Howe'.length) === 'LAWeek4___Andrew_Howe') {
